...
def _resolve_colmap_exe(colmap_exe: str) -> str:
    ...
    for candidate in (
        r"C:\Users\Phuong\COLMAP-3.8-windows-cuda\bin\colmap.exe",
        "colmap.exe",
        "COLMAP.exe",
        "colmap",
...
def _run_colmap(colmap_exe: str, args, log_path: str, cwd: str):
    ...
    # copy env và thêm thư mục lib vào PATH nếu chạy exe trên Windows
    env = os.environ.copy()
    if exe.lower().endswith(".exe") and os.name == "nt":
        lib_dir = r"C:\Users\Phuong\COLMAP-3.8-windows-cuda\lib"
